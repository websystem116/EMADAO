          ...
          <div className="header-wrapper">
            <div className="menu-logo-adjust d-flex align-items-center">
              ...
              <ul className={`main-menu ${openMenu && 'active act'}`}>
                ...
                <li>
                  <Link href="/events/football">Football</Link>
                </li>
                <li>
                  <Link href="/events/tennis">Tennis</Link>
                </li>
                <li>
                  <Link href="/events/cricket">V-Sport</Link>
                </li>
                <li>
                  <Link href="/events/dota-2">eSports</Link>
                </li>
                    ...
                    <li>
                      <ul className="menu-promot menu-promot-first">
                        ...
                        <li>
                          ...
                          <Link href="events/live" className={`main-list-menu-live ${pathname == '/events/live' && 'active'}`}>
                            <div className="icon">
                            ...
                            <>
                              {
                                sortedSports.map((sport) => (
                                  <li key={sport.name} >
                                    <Link href={`/events/${sport.slug}`} className={`${pathname == `/${sport.name}` && 'active'}`}>
                                      <div className="icon">
            ...
            <div className="modal-content">
              <div className="modal-header">
                <div className="head">
                  ...
                  <p>
                    Do not have an account? <Link href="#0" className="text-base" data-bs-toggle="modal" data-bs-target="#exampleModal2">Sign up</Link>
                  </p>
                </div>
              </div>
            ...
            <div className="modal-content">
              <div className="modal-header">
                <div className="head">
                  ...
                  <p>
                    Already have an account? <Link href="#0" className="text-base" data-bs-toggle="modal" data-bs-target="#exampleModal">Login</Link>
                  </p>
                </div>
              </div>
              <button type="button" className="btn-close cross-btn" data-bs-dismiss="modal" aria-label="Close"></button>
